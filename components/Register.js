...
export default class Register extends Component {
  ...
  render() {
    return (
      ...
      <ImageBackground source={bgImage} style={registerStyles.backgroundContainer}>
      <View style={registerStyles.logoContainer}>
      <Image source={bgLogo} style={registerStyles.logo}></Image>
          <Text style ={registerStyles.logoText}></Text>
          <Text style ={registerStyles.logoText}> Register</Text>
      </View>
      ...
      <TouchableOpacity style={registerStyles.btnLogin}>
